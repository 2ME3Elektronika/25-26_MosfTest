...
void MuestraP() {
// Si valores coinciden, Mosfet funciona correctamente
  if (Vds_onP < 6.0 && Vds_offP < 6.0) {
    text = 7;
    Mensaje();
// Si valores NO coinciden, Mosfet NO funciona correctamente
  } else {
    text = 8;
    Mensaje();
  }
...
// ================== RELES P ==================
// Activa los relés conectados al circuito para comprobación Canal P
void RelesP() {
